      ...
      if (e?.response?.data) {
        setDeleteError(
          e.response.data.error ||
            ...
            "Error al eliminar el tour.",
        );
      } else {
        setDeleteError(
          err instanceof Error ? err.message : "Error al eliminar el tour.",
        );
      }
    } finally {
      setDeleting(false);
                ...
                {tours.map((tour: Tour) => (
                  <TableRow key={tour.id_tour}>
                    ...
                    <TableCell className="text-center">
                      {tour.supplier?.company || `Prov ${tour.supplier_corporate}`}
                    </TableCell>
                    <TableCell className="text-center">
                      <span
