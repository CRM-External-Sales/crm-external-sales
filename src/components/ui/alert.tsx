  ...
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-red-500/50 text-red-700 bg-red-50 dark:border-red-500 dark:text-red-400 dark:bg-red-950/20 [&>svg]:text-red-600 dark:[&>svg]:text-red-400",
        success:
        ...
        warning:
          "border-amber-500/50 text-amber-700 bg-amber-50 dark:border-amber-500 dark:text-amber-400 dark:bg-amber-950/20 [&>svg]:text-amber-600 dark:[&>svg]:text-amber-400",
        info:
