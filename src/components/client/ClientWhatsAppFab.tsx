...
import { useClientWhatsAppMessageOverride } from "@/features/client-home/ClientWhatsAppMessageContext";
import { getClientWhatsAppMessage } from "@/lib/client-whatsapp-message";
import { openWhatsApp } from "@/lib/whatsapp";

export function ClientWhatsAppFab() {
  const pathname = usePathname();
  const messageOverride = useClientWhatsAppMessageOverride();

  const handleClick = () => {
    openWhatsApp(messageOverride ?? getClientWhatsAppMessage(pathname));
  };
